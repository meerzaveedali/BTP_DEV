		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#qualityassurance-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"qualityassurance-display": {
								"semanticObject": "qualityassurance",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=qualityassurance",
									"url": sap.ui.require.toUrl("qualityassurance")
								}
							}
						}
					}
