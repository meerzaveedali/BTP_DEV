		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Finance",
									"targetURL": "#combrsrfinance-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"combrsrfinance-display": {
								"semanticObject": "combrsrfinance",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.brsr.finance",
									"url": sap.ui.require.toUrl("com/brsr/finance")
								}
							}
						}
					}
